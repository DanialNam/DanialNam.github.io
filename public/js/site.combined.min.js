 ...
 * @build          Sat, Apr 20, 2019 9:49 PM ET
 * @release        7e72952f45a4553842a15b7f807f07f2b6880430 [master]
...
var myModule=angular.module("DanialGithubPage",["ngRoute","ngAnimate","DanialGithubPage.Main","angular-google-analytics"]);myModule.config(["$routeProvider","AnalyticsProvider",function(e,a){e.when("/welcome",{templateUrl:"public/html/welcome.html"}).when("/main/:section",{templateUrl:"public/html/main.html"}).otherwise({redirectTo:"/welcome"}),window.dataLayer=window.dataLayer||[];var n=window.location.href;n.includes("127.0.0.1:8080")||a.setAccount("UA-124568449-1")}]),myModule.run(["Analytics","languageService",function(e,a){a.setLanguage("en")}]),angular.element(function(){});
angular.module("DanialGithubPage.Main",[]),angular.module("DanialGithubPage.Main").controller("MainCtrl",["$scope","languageService","listFactory","$timeout","$location","$rootScope","$routeParams","loadingViewService",function(o,a,t,n,i,e,c,v){function s(o){void 0==u.navs&&(void 0==o&&(o="about"),u.navs=[{txt:"About",active:"about"==o,code:"about"},{txt:"Portfolio",active:"about"!=o,code:"portfolio"}])}function r(o){for(var a=-1,t=0;t<u.navs.length;t++)u.navs[t].active&&(a=t);if(code=u.navs[a].code,code!=o){for(var t=0;t<u.navs.length;t++)u.navs[t].code==o&&(a=t),u.navs[t].active=!1;u.navs[a].active=!0}}var u=this,l=!0;e.$watch("languageSelectFlag",function(o,a){s(u.section)}),o.$on("$routeChangeStart",function(o,a,t){"$$route"in a&&(originalPath=a.$$route.originalPath,route=originalPath.split("/")[1],section=a.params.section,l&&(u.section=section,r(section),l=!1),"main"==route?(u.showNav||(u.showNav=!0),u.section!=section&&n(function(){v.removeLoadingView(),void 0!=section&&(u.section=section,r(section))},500)):u.showNav=!1)}),u.goToHome=function(){u.showNav=!1,i.path("/")},u.clickNav=function(o){for(var a=-1,t=0;t<u.navs.length;t++)u.navs[t].active&&(a=t),u.navs[t].active=!1;u.navs[o].active=!0,a!=o&&(v.getLoadingView(),u.section=void 0,n(function(){i.path("/main/"+u.navs[o].code)},500))}}]);
angular.module("DanialGithubPage.Main").directive("compileTemplate",["$compile","$parse",function(n,i){return{link:function(t,e,a){function l(){return(u(t)||"").toString()}var u=i(a.ngBindHtml);t.$watch(l,function(){n(e,null,-9999)(t)})}}}]);
angular.module("DanialGithubPage.Main").directive("mainSection",["$timeout","$location","$window",function(n,e,t){return{restrict:"E",replace:!0,transclude:!0,templateUrl:"public/html/mainSection.html",link:function(e,i,a,r){function o(){infoHeight=t.innerWidth>600?206:106,e.aboutTextHeight={height:t.innerHeight-236-infoHeight+"px"}}function l(){var n=.8*t.innerWidth;n=n>440?440:n,e.aboutInfoCardStyle={width:n+"px","margin-left":-n/2+"px"}}function u(){for(var n=[],e=["#Data Analysis","#Deep Learning","#Neural Network","#JAVA","#HTML/CSS","#AngularJS 1.X","#Kafka","#Python","#Flask","#Web Crawling","#Scrapy","#Neural Network","#Linux","AWS","#Spring Boot","#MySQL","#MongoDB","#Gulp","#NodeJs","#Sketch","#JPA"],t=0;t<e.length;t++)n.push({txt:e[t]});return n}n(function(){e.expendSectionBox=!0},300),e.sectionWrapStyle={height:t.innerHeight-160+"px"},l(),o(),angular.element(t).bind("resize",function(){e.sectionWrapStyle.height=t.innerHeight-160+"px",o(),l(),e.$digest()}),e.skills=u()}}}]);
angular.module("DanialGithubPage.Main").directive("portfolio",["$timeout","$location","$window","portfolioFactory","$rootScope",function(o,t,i,e,n){return{restrict:"E",replace:!0,transclude:!0,templateUrl:"public/html/portfolio.html",link:function(t,l,c,r){function h(){section_width=$(".section--box")[0].clientWidth,section_height=$(".section--box")[0].clientHeight,portfolio_ul_width=$(".portfolio--ul")[0].clientWidth,portfolio_ul_height=$(".portfolio--ul")[0].clientHeight,t.showcaseWidthStyle={width:portfolio_ul_width+5+"px",height:portfolio_ul_height+"px"},t.descriptionHeight=portfolio_ul_height-40+"px",t.closeBtnPosition={right:(section_width-portfolio_ul_width)/2-15+"px",top:(section_height-portfolio_ul_height)/2+"px"},section_width>800?t.firstColumnMarginLeft="77.5px":section_width>645?t.firstColumnMarginLeft=(section_width-645)/2+"px":t.firstColumnMarginLeft=""}n.showNotebookUrl=!1,n.notebookUrl="",t.portfolios=e.getPortfolios(),h(),t.$watch("portfolio",function(o,t){h()}),angular.element(i).bind("resize",function(){h(),t.$digest()}),t.clickPortfolio=function(i){"0px"==t.showcaseWidthStyle.height&&h(),t.showPortfolioDetail=!0,t.contents={},angular.copy(t.portfolios[i],t.contents),o(function(){t.isContentsReady=!0},500)},t.closeShowcase=function(){t.isContentsReady=!1,t.showPortfolioDetail=!1,t.contents.video_url="",o(function(){t.contents={}},500)},t.clickShowNotebookBtn=function(o){n.showNotebookUrl=!0,n.notebookUrl=o},n.closeNotebookShowcase=function(){n.showNotebookUrl=!1,n.notebookUrl=""}}}}]);
angular.module("DanialGithubPage.Main").directive("selectLanguage",["$timeout","$location","languageService","listFactory","$window",function(e,t,n,a,i){return{restrict:"E",replace:!0,transclude:!0,templateUrl:"public/html/selectLanguage.html",link:function(g,l,u,r){e(function(){g.isJustEntered=!0},300),g.languageSelectWrapStyle={height:i.innerHeight-160+"px"},angular.element(i).bind("resize",function(){g.languageSelectWrapStyle.height=i.innerHeight-160+"px",g.$digest()}),g.languageList=a.getLanguageOption(),g.selectLanguage=function(e){n.setLanguage(g.languageList[e].code),g.isJustEntered&&(g.isJustEntered=!1,t.path("/main/about"))}}}}]);
angular.module("DanialGithubPage.Main").service("languageService",["$rootScope","languageFactory","loadingViewService","$timeout",function(e,a,g,n){var o=this;o.setLanguage=function(o){if(e.languageSelectFlag=!e.languageSelectFlag,e.globLang!=o){var i=!1;void 0==e.globLang||i||(i=!0,g.getLoadingView()),a.getLanguage(o).then(function(a){e.globLang=o,e.glob=a.data,i&&n(function(){i=!1,g.removeLoadingView()},1e3)},function(e){console.log("Occured error.")})}}}]);
angular.module("DanialGithubPage.Main").service("loadingViewService",["$rootScope",function(i){var n=this;n.getLoadingView=function(){i.isLoading=!0},n.removeLoadingView=function(){i.isLoading=!1}}]);
angular.module("DanialGithubPage.Main").service("routerService",["$rootScope",function(i){var e=this;e.getLoadingView=function(){i.isLoading=!0},e.removeLoadingView=function(){i.isLoading=!1}}]);
angular.module("DanialGithubPage.Main").factory("languageFactory",["$http",function(t){function a(a){return t.get("public/asset/text/"+a+".json")}return{getLanguage:a}}]);
angular.module("DanialGithubPage.Main").factory("listFactory",function(){function n(){return[{txt:"English",code:"en"},{txt:"Korean",code:"ko"}]}return{getLanguageOption:n}});
angular.module("DanialGithubPage.Main").factory("portfolioFactory",["$rootScope","$sce",function(t,a){function o(){var o=t.glob;return[{type:3,about:"Deep Learning(CNN)",isOngoing:!0,title:"Humpback Whale Identification",description:o["humpback whale identification description"],description_detail:a.trustAsHtml(o["humpback whale identification description detail"]),algorithm:"Convolutional Neural Network",programmingLanguage:"",lang_li:["python"],framework:"",server:"AWS EC2","package":"Numpy, Pandas, Matplotlib, Seaborn, Tensorflow",product_url_txt:"Github Repository",product_url:"https://github.com/DanialDaeHyunNam/Humpback_Whale_Identification",demo_url_txt:"",demo_url:"",is_video:!1,"class":"portfolio--humpback--whale",previewClass:"portfolio--humpback--whale",notebookUrl:"",code:"humpback--whale--identification"},{type:1,about:"Classification",title:"Walmart Trip Type Classification",description:o.walmat_triptype_description,description_detail:a.trustAsHtml(o.walmat_triptype_description_detail),algorithm:"Gradient Descent Boosting",programmingLanguage:"",lang_li:["python"],framework:"",server:"","package":"Numpy, Pandas, Matplotlib, Seaborn, XGBoost, Scikitlearn",product_url_txt:"Github Repository",product_url:"https://github.com/DanialDaeHyunNam/Walmart_Trip_Type_Classification",demo_url_txt:"Kaggle Competition",demo_url:"https://www.kaggle.com/c/walmart-recruiting-trip-type-classification",is_video:!1,"class":"portfolio--walmart--triptype",previewClass:"walmart--triptype--preview",notebookUrl:"public/html/Walmart_TripType.html",code:"walmart_triptype"},{type:3,about:"NLP & LDA Topic Modeling",isOngoing:!0,title:"Topic modeling of Instagram posts",description:o.insta_scrapy_description,description_detail:a.trustAsHtml(o["insta_scrapy_description detail"]),algorithm:"Nature Language Processing, LDA Topic Modeling",programmingLanguage:"",lang_li:["python"],framework:"Scrapy",server:"","package":"Numpy, Pandas, Matplotlib, Seaborn, Tensorflow",product_url_txt:"Github Repository",product_url:"https://github.com/DanialDaeHyunNam/Topic_Modeling_Of_Instagram_Posts",demo_url_txt:"",demo_url:"",is_video:!1,"class":"portfolio--instagram--scrapy",previewClass:"portfolio--instagram--scrapy",notebookUrl:"public/html/Instagram-Data-Clustering.html",code:"instagram--topic--modeling"},{type:0,about:"App Development",title:"Just For Me",description:o.jfm_description,algorithm:"",programmingLanguage:"JAVA, HTML/CSS, Javascript, Typescript, MySQL",lang_li:["java","html5","angular","js-square","aws"],framework:"Spring boot, Cordova, AngularJS 1.X, JPA",server:"AWS(EC2, S3, RDS, SES, Lambda)","package":"",product_url_txt:"Appstore",product_url:"https://itunes.apple.com/app/just-for-me/id1212756322?mt=8",demo_url_txt:"Youtube Demo Video",demo_url:"https://www.youtube.com/watch?v=nfakb_5zkaY",is_video:!0,video_url:a.trustAsResourceUrl("../../video/jfm_tutorial.mp4#toolbar=0"),"class":"portfolio--jfm",notebookUrl:"",previewClass:"",code:"jfm"},{type:1,about:"Linear Regression",title:"Walmart Sales in Stormy Weather Project",description:o.walmat_stormy_description,description_detail:a.trustAsHtml(o.walmat_stormy_description_detail),programmingLanguage:"",lang_li:["python"],algorithm:"Ordinary Least Squares",framework:"",server:"","package":"Numpy, Pandas, Matplotlib, Seaborn, Statsmodel",product_url_txt:"Github Repository",product_url:"https://github.com/DanialDaeHyunNam/Walmart_Sales_in_Stormy_Weather_Project_by_Python",demo_url_txt:"Kaggle Competition",demo_url:"https://www.kaggle.com/c/walmart-recruiting-sales-in-stormy-weather",is_video:!1,video_url:"","class":"portfolio--walmart--stormy",previewClass:"walmart--stormy--preview",notebookUrl:"public/html/Walmart Sales in Stormy Weather Project.html",code:"walmart_stormy_weather"},{type:2,about:"Front End",title:"Danial's portfolio web site",description:o.portfolio_description,algorithm:"",programmingLanguage:"HTML/CSS, Javascript",lang_li:["html5","css3","angular","js-square"],framework:"AngularJS 1.X, Gulp",server:"Github Blog","package":"",product_url_txt:"Url",product_url:"?",demo_url_txt:"",demo_url:"",is_video:!1,video_url:"","class":"portfolio--portfolioSite",previewClass:"portfolio--preview",notebookUrl:"",code:"portfolio_web"},{type:2,about:"Front End",title:"Databuzz team tech blog",description:o.databuzz_team_tech_blog,description_detail:a.trustAsHtml(o.databuzz_team_tech_blog_detail),algorithm:"",programmingLanguage:"Pug, CSS, Markdown",lang_li:["html5","css3","markdown","js-square"],framework:"Hexo",server:"","package":"",product_url_txt:"Url",product_url:"https://databuzz-team.github.io/categories/Danial-Nam/",demo_url_txt:"",demo_url:"",is_video:!1,"class":"portfolio--databuzz--blog",previewClass:"databuzz--blog--preview",notebookUrl:"",code:"databuzz_blog"}]}return{getPortfolios:o}}]);