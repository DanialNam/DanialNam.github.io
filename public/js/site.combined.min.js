 ...
 * @build          Wed, Oct 17, 2018 5:02 PM ET
 * @release        5826c67ab4d5337884fc83c4a16b008de7194463 [master]
...
var myModule=angular.module("DanialGithubPage",["ngRoute","ngAnimate","DanialGithubPage.Main","angular-google-analytics"]);myModule.config(["$routeProvider","AnalyticsProvider",function(e,n){e.when("/welcome",{templateUrl:"public/html/welcome.html"}).when("/main/:section",{templateUrl:"public/html/main.html"}).otherwise({redirectTo:"/welcome"}),n.setAccount("UA-124568449-1")}]),myModule.run(["Analytics","languageService",function(e,n){n.setLanguage("en")}]),angular.element(function(){});
...
angular.module("DanialGithubPage.Main").directive("mainSection",["$timeout","$location","$window",function(n,i,t){return{restrict:"E",replace:!0,transclude:!0,templateUrl:"public/html/mainSection.html",link:function(i,e,a,r){function o(){infoHeight=t.innerWidth>600?206:106,i.aboutTextHeight={height:t.innerHeight-236-infoHeight+"px"}}function l(){var n=.8*t.innerWidth;n=n>440?440:n,i.aboutInfoCardStyle={width:n+"px","margin-left":-n/2+"px"}}function c(){for(var n=[],i=["#Data Analysis","#Machine Learning","#Artificial Intelligence","#JAVA","#HTML/CSS","#AngularJS 1.X","#Python","#Flask","#Web Crawling","#Scrapy","#Neural Network","#Linux","AWS","#Spring Boot","#MySQL","#MongoDB","#Gulp","#NodeJs","#Sketch","#JPA"],t=0;t<i.length;t++)n.push({txt:i[t]});return n}n(function(){i.expendSectionBox=!0},300),i.sectionWrapStyle={height:t.innerHeight-160+"px"},l(),o(),angular.element(t).bind("resize",function(){i.sectionWrapStyle.height=t.innerHeight-160+"px",o(),l(),i.$digest()}),i.skills=c()}}}]);
